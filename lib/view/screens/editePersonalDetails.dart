...
class EditPersonalDetails extends StatelessWidget {
  ...
  EditPersonalDetailsController controller = Get.put<EditPersonalDetailsController>(EditPersonalDetailsController());
  final w = Get.width;
    ...
    return Scaffold(
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          ...
          child:GetBuilder<EditPersonalDetailsController>(
          ...
          onPressed: () async{
          await  controller.editProfileSendData(bio:bioTxtController.text, address:addressTxtController.text, mobile:phoneTxtController.text , edu: '', exp :'');
